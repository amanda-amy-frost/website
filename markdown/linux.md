...
And it's not just marginal - it has improved by leaps and bounds. [Wayland](https://wayland.freedesktop.org/) is now the standard for non-tiling window managers, [Flatpaks](https://flatpak.org/) and [Flathub](https://flathub.org/en) offer easier packaging and distribution of especially GUI programs across multiple distros, and [hardware compatibility](https://www.phoronix.com/review/linux-71-features-changes/2) is much less of an issue. Best of all, the available software has skyrocketed in both quality and [quantity](https://repology.org/repositories/graphs).

And it's not just marginal - it has improved by leaps and bounds. [Wayland](https://wayland.freedesktop.org/) is now the standard for display servers, [Flatpaks](https://flatpak.org/) and [Flathub](https://flathub.org/en) offer easier packaging and distribution of especially GUI programs across multiple distros, and [hardware compatibility](https://www.phoronix.com/review/linux-71-features-changes/2) is much less of an issue. Best of all, the available [software](https://repology.org/repositories/graphs) has skyrocketed in both quality and quantity.
...
The ability for Linux to almost entirely avoid enshittification and actually improve, while quality has declined in every other area of tech, is first and foremost due to its *raison d'être*. It was not created to make money; it was created to solve a problem and to benefit others.
